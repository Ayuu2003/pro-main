...
<body class="biolife-body" style="background-image: url('https://img.freepik.com/free-photo/abstract-marble-texture-black-white-grey-background-handmade-technique_1258-99671.jpg');">
    <!-- Preloader -->
            ...
            <div class="container">
                ...
                <?php foreach ($pro_datas as $pro_data): ?>
                    <div class="product-attribute">
                        ...
                        <div class="price">
                            <ins><span class="price-amount">₹. <?php echo $pro_data['pdt_price']; ?></span></ins>
                        </div> -->
                        <!-- Add to cart form -->
                            ...
                            <div class="contain-product layout-default">
                                <div class="product-thumb">
                                    <a href="single_product.php?status=singleproduct&&id=<?php echo $r_pro['pdt_id']; ?>" class="link-to-product">
                                        <img src="admin/uploads/<?php echo $r_pro['pdt_img']; ?>" alt="Product Image" width="270" height="270" class="product-thumnail">
                                    </a>
                                </div>
                                <div class="info">
                                    ...
                                    <div class="price">
                                        <ins><span class="price-amount">₹. <?php echo $r_pro['pdt_price']; ?></span></ins>
                                    </div>
