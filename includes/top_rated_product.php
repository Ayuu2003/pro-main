...
<div class="advance-product-box">
                                ...
                                <div class=" biolife-banner__style-01 sm-margin-top-30px xs-margin-top-80px">
                                    <div >
                                        <a href="#" class="bn-link"></a>
                                        <div>
                                            <span class="first-line"><h1> <b>Daily Fresh Natural Plants </b></h1> 
                                            <h1><b>Premium Quality</b></h1></span>
                                            <i ></i>
                                            <span></span>
                                        </div>
                                    </div>
